...
use Acme\UserBundle\Form\UserFilterType;
...
class UserController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('AcmeUserBundle:User')->createQueryBuilder('e');
    ...
    */
    protected function paginator($queryBuilder)
    {
        ...
        {
            return $me->generateUrl('admin_usuarios', array('page' => $page));
        };
     ...
     * @Method("POST")
     * @Template("AcmeUserBundle:User:new.html.twig")
     */
     ...
     * @Method("PUT")
     * @Template("AcmeUserBundle:User:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
	    $registration = $editForm->getData();

	  $password = $registration->getPassword();
          $entity->setPassword(password_hash($password, PASSWORD_BCRYPT, array()));
